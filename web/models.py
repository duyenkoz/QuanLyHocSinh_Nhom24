...
class Students(db.Model):
    ...
    class_id = db.Column(db.Integer, db.ForeignKey('classes.id'), nullable=True)  # Liên kết với bảng Classes
    ...
    class_ = db.relationship('Classes', backref='students', lazy=True)
...
def seed_data():
    if not Users.query.first():
        ...
        user = Users(
            name="Regular User",
            username="user",
            password=str(hashlib.md5('user'.encode('utf-8')).hexdigest()),
